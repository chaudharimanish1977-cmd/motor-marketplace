        ...
        <div className="max-w-lg w-full bg-white border border-rose-200 rounded-2xl shadow-soft p-6 md:p-8">
          ...
          <div className="mt-5 flex items-center gap-2">
            <button
              type="button"
              onClick={reset}
              className="inline-flex items-center gap-1.5 px-4 py-2 bg-brand-charcoal hover:brightness-110 text-white text-sm font-semibold rounded-xl transition-colors"
            >
