...
export interface PolicyReport {
  ...
  /**
   * Aryan's 1-2 sentence verdict, top-of-report executive summary. Auto-
   * generated by the LLM at report-generation time using the rest of the
   * report as context. Customer reads this in 5 seconds and knows what to
   * do; everything else is the defense.
   *
   * Examples:
   *   "Solid policy. Adding Engine Protector closes a ₹2L exposure for ₹800/yr."
   *   "Acko's renewal is a clear upgrade. Take it, but ask about NCB Protection."
   */
  bottomLine?: string;
