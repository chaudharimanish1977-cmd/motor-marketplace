...
export function RenewalPreview() {
  const milestones: {
  ...
  }[] = [
    {
      ...
      sub: "Email nudge",
      icon: Mail,
      accent: "text-brand-deepblue",
      bg: "bg-blue-50",
      bar: "bg-brand-deepblue/30",
    },
    {
      label: "T-30 days",
      sub: "Pre-quote SMS",
      icon: MessageSquare,
      accent: "text-brand-electricblue",
      bg: "bg-sky-50",
      bar: "bg-brand-electricblue/40",
    },
    {
      label: "T-7 days",
      sub: "Action reminder",
    ...
    <section className="mt-24 max-w-5xl w-full">
      <div className="rounded-3xl bg-gradient-to-br from-white to-brand-offwhite border border-brand-light-gray shadow-soft overflow-hidden">
        <div className="px-6 md:px-8 py-7 grid md:grid-cols-[1fr_2fr] gap-6 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.12em] text-brand-deepblue bg-blue-50 border border-blue-100 rounded-full mb-3">
          ...
          <div className="relative">
            <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 h-0.5 bg-gradient-to-r from-brand-deepblue via-brand-orange to-brand-success rounded-full" />
