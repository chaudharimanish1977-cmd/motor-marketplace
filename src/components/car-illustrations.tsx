 ...
 *
 * All silhouettes share: spinning wheels (via CSS), brand-deepblue body,
 * headlight + taillight + bumpers + door handles. Differences are silhouette
 * shape, wheel size/style, and brand-specific cues (Audi's grille, etc.).
 */
...
function HatchbackCar({ x, y }: { x: number; y: number }) {
  return (
    <g transform={`translate(${x}, ${y})`}>
      ...
      {/* B-pillar */}
      <rect x="54" y="7" width="2" height="12" fill="#0A2463" />
      ...
      {/* Mirror */}
      <path d="M 31,16 L 27,13 Q 26,13 26,14.5 L 29,17 Z" fill="#0A2463" />

      {/* Wheel arches */}
      <circle cx="24" cy="36" r="8.5" fill="#0A2463" />
      <circle cx="86" cy="36" r="8.5" fill="#0A2463" />
      ...
      {/* Taillight */}
      <rect x="9" y="26" width="3.5" height="4" rx="0.7" fill="#FF6B35" />
    </g>
  );
}
...
function CompactSedanCar({ x, y }: { x: number; y: number }) {
  return (
    <g transform={`translate(${x}, ${y})`}>
      ...
      <rect x="64" y="9" width="2" height="12" fill="#0A2463" />
      ...
      <path d="M 40,18 L 36,14 Q 35,14 35,15.5 L 38,19 Z" fill="#0A2463" />

      <circle cx="30" cy="38" r="10" fill="#0A2463" />
      <circle cx="100" cy="38" r="10" fill="#0A2463" />
      ...
      <rect x="13" y="28" width="3.5" height="4" rx="0.8" fill="#FF6B35" />
    </g>
  );
}
...
function LuxurySedanCar({ x, y }: { x: number; y: number }) {
  return (
    <g transform={`translate(${x}, ${y})`}>
      ...
      <rect x="70" y="10" width="2" height="11" fill="#0A2463" />
      ...
      {/* Sporty side mirror */}
      <path d="M 47,18 L 42,14 Q 41,14 41,15.5 L 45,19 Z" fill="#0A2463" />

      {/* Wheel arches — slightly smaller for low-profile stance */}
      <circle cx="28" cy="38" r="11" fill="#0A2463" />
      <circle cx="106" cy="38" r="11" fill="#0A2463" />
      ...
      <rect x="6" y="28" width="5" height="3" rx="0.5" fill="#FF6B35" />
...
function CompactSuvCar({ x, y }: { x: number; y: number }) {
  return (
    <g transform={`translate(${x}, ${y})`}>
      ...
      <rect x="64" y="8" width="2" height="14" fill="#0A2463" />
      ...
      <path d="M 34,18 L 30,14 Q 29,14 29,15.5 L 32,19 Z" fill="#0A2463" />

      {/* BIGGER wheel arches (SUV trait) */}
      <circle cx="28" cy="38" r="11.5" fill="#0A2463" />
      <circle cx="100" cy="38" r="11.5" fill="#0A2463" />
      ...
      {/* Taillight */}
      <rect x="10" y="28" width="4" height="4" rx="0.8" fill="#FF6B35" />
    </g>
  );
}
...
function LuxurySuvCar({ x, y }: { x: number; y: number }) {
  return (
    <g transform={`translate(${x}, ${y})`}>
      ...
      <path d="M 30,15 C 33,7 40,5.5 48,5.5 L 88,5.5 C 96,5.5 102,7 104,15 Z" fill="#0A2463" />
      <path
      ...
      <rect x="64" y="7" width="2" height="15" fill="#0A2463" />
      <line x1="65" y1="23" x2="65" y2="38" stroke="rgba(0,0,0,0.28)" strokeWidth="0.6" />
      <rect x="42" y="28" width="10" height="1.4" rx="0.5" fill="#e0e6eb" />
      <rect x="84" y="28" width="10" height="1.4" rx="0.5" fill="#e0e6eb" />
      <path d="M 36,18 L 32,13 Q 31,13 31,15 L 34,19 Z" fill="#0A2463" />

      <circle cx="30" cy="38" r="12" fill="#0A2463" />
      <circle cx="106" cy="38" r="12" fill="#0A2463" />
      ...
      <rect x="7" y="28" width="5" height="3.5" rx="0.5" fill="#FF6B35" />
    </g>
  );
}
