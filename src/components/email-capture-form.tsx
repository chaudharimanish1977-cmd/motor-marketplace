  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full inline-flex items-center justify-center gap-2 py-2.5 bg-brand-deepblue hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold text-sm rounded-xl transition-all"
      >
        {submitting ? (
          <>
