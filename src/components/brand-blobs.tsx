...
export function BrandBlobs() {
  return (
    ...
    >
      <div className="absolute -top-32 -left-32 w-[42rem] h-[42rem] rounded-full bg-brand-charcoal/10 dark:bg-brand-charcoal/30 blur-3xl" />
      <div className="absolute -top-20 right-[-10%] w-[34rem] h-[34rem] rounded-full bg-brand-charcoal/10 dark:bg-brand-charcoal/25 blur-3xl" />
      <div className="absolute bottom-[-15%] left-[20%] w-[36rem] h-[36rem] rounded-full bg-brand-plum/8 dark:bg-brand-plum/15 blur-3xl" />
    </div>
  );
}
